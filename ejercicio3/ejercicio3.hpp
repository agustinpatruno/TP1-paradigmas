...
class  PersonajeFactory
{
    public:
        ...
        */
        ...
        unique_ptr<arma> crear_arma_factory(armas_totales tipo_arma, float dato1, float dato2, float dato3);
        /*
        ...
        */
        ...
        unique_ptr<personaje> crear_personaje_factory(personajes_totales personaje, hab_totales habilidad, int dato1, float dato_personal);
        /*
        ...
        */
        ...
        unique_ptr<personaje> crear_personaje_armado_factory(personajes_totales perso,hab_totales hab_especial, int dato1, float dato_personal, armas_totales tip_arma, float dato2, float dato3, float dato4);
        /*
