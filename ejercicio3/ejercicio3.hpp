...
/*
    genera un numero entero aleatorio dentro del rango que le pasemos
*/
...
class personaje_armado
{
    ...
    public:
        ...
        */
        ...
        void crear_arma(armas_magicas_y_combate tip_arma, habilidades_especiales_magicas_y_combate habilidad_espe);
        /*
...
class  PersonajeFactory
{
    public:
        ...
        shared_ptr<arma> crear_arma(armas_magicas_y_combate tip_arma, double daño, int cant_usos_dispo, habilidades_especiales_magicas_y_combate habilidad_espe, double daño_extra_espe, int cant_usos_espe);

        shared_ptr<personaje> crear_personaje(tipos_personajes personaje, double hp, auto dato1, auto dato2, habilidades_especiales_magicas_y_combate hab_especial);

        shared_ptr<personaje_armado> crear_personaje_armado(tipos_personajes personaje, double hp, auto dato1, auto dato2, habilidades_especiales_magicas_y_combate hab_especial,armas_magicas_y_combate tip_arma, double daño, int cant_usos_dispo, habilidades_especiales_magicas_y_combate habilidad_espe, double daño_extra_espe, int cant_usos_espe);
};
